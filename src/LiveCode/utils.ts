...
const STORAGE_DARK_THEME = 'live-code-prefer-dark'

export const setLiveCodeTheme = (theme: ITheme) => {
  localStorage.setItem(STORAGE_DARK_THEME, String(theme === 'dark'))
  document
    .querySelectorAll('div[data-id="live-code"]')
    ?.forEach((item) => item.setAttribute('class', theme))
}

export const getLiveCodeTheme = () => {
