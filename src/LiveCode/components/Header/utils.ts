...
import { IMPORT_MAP_FILE_NAME } from '@/LiveCode/files'
import eslintrc from '@/LiveCode/template/.eslintrc.cjs?raw'
import gitignore from '@/LiveCode/template/.gitignore?raw'
import index from '@/LiveCode/template/index.html?raw'
import pkg from '@/LiveCode/template/package.json?raw'
import readme from '@/LiveCode/template/README.md?raw'
import tsconfig from '@/LiveCode/template/tsconfig.json?raw'
import tsconfigNode from '@/LiveCode/template/tsconfig.node.json?raw'
import config from '@/LiveCode/template/vite.config.js?raw'
